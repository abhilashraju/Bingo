...
public:
  ...
  */
  explicit param_list(std::string_view s) : s_(s) {}
...
public:
  ...
  */
  using value_type = std::pair<std::string_view, param_list>;
  ...
  /** Construct a list.
      ...
      must remain valid for the lifetime of the container.
  */
  explicit ext_list(std::string_view s) : s_(s) {}
  ...
  /** Find a token in the list.
      ...
      token exists.
  */
  inline const_iterator find(std::string_view const &s);

  /** Return `true` if a token is present in the list.

      @param s The token to find. A case-insensitive comparison is used.
  */
  inline bool exists(std::string_view const &s);
};
...
public:
  ...
  /** Construct a list.
      ...
      must remain valid for the lifetime of the container.
  */
  explicit token_list(std::string_view s) : s_(s) {}
